...
// Controller
//-------------------------
app.controller('CtrlM03', function($scope,$rootScope,$http,$window,$timeout,$sce,$filter,xService){
    $scope._mode="dev_ref_upd";
    $scope._table="life_exp";
    $scope._height = 0;
    $scope.arg = {};
    ...
    $scope.grid_render = function(){
        ...
        $scope.gridColumns.push({ field: 'umdns_desc' ,width: 180 ,name:'UMDNS Description'});
        $scope.gridColumns.push({ field: 'life_expectancy',width: 100 ,name:'Life Expectancy(years)',cellClass: 'txt_right'});
        $scope.gridColumns.push({ field: 'gmdn_dev_cc',width: 100 ,name:'GMDN Device Category Cade',cellClass: 'txt_right'});
        $scope.gridColumns.push({ field: 'umdns_dev_grp',width: 100 ,name:'UMDNS Device Group'});
